          ...
          <div className="itempage-wrapper">
            ...
            <div className="block-right">
              ...
              <div className="item-weight">
                <img
                  src={selectedItem?.format === 'мл' ? bottleIcon : boxIcon}
              ...
              <div className="item-control">
                <form action="" id="form-controlling">
                  ...
                  <div className="quantity-control">
                    ...
                    <span>{itemCount}</span>
                    <button className="btn-add-amount" onClick={incrementCount}>
                      +
                    </button>
                  </div>
                  <div
              ...
              <div className="item-data">
                <ul id="description" className="data-list">
                  <li className="list-unmarked">
                    Производитель: <span>{selectedItem.manufacturer}</span>
                  </li>
                  <li className="list-unmarked">
                    Бренд: <span>{selectedItem.brand}</span>
                  </li>
                  <li className="list-unmarked">
                    Артикул: <span>{460404}</span>
                  </li>
                  <li className="list-unmarked">
                    Тип ухода: <span>{selectedItem.care}</span>
                  </li>
                  <li className="list-unmarked">
                    Кол-во в коробке: <span>1</span>
                  </li>
                  <li className="list-unmarked">
                    Штрихкод: <span>{selectedItem.barcode}</span>
                  </li>
                  <li className="list-unmarked">
                    Размеры коробки
                    <span className="size-abbreviation">(Д*Ш*В)</span>:{' '}
                    <span></span>
                  </li>
                  <li className="list-unmarked">
                    Вес коробки:{' '}
              ...
              <div className="item-data">
                <ul id="params" className="parameters-list hidden">
                  <li className="list-unmarked">
                    Назначение: <span>{selectedItem.brand}</span>
                  </li>
                  <li className="list-unmarked">
                    Тип: <span>{selectedItem.brand}</span>
                  </li>
                  <li className="list-unmarked">
                    Производитель: <span>{selectedItem.manufacturer}</span>
                  </li>
