...
const MainCatalogue: FC = () => {
    ...
    return (
      <div key={element.id} className="item-card">
        ...
        <div className="item-weight">
          <img
            src={element.format === 'мл' ? bottleIcon : boxIcon}
  ...
  const handleItemsSorting = (e: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  const currentSetOfItems =
    paginatedItems.length === 0 ? itemsToRender : paginatedItems;
        ...
        <div className="catalogue-content">
          <div className="breadcrumbs-nav-wrapper">
            ...
            <ul className="breadcrumbs-nav">
              ...
              <Link to="/" className="breadcrumbs-nav-link link-plain active">
                Косметика и гигиена
              </Link>
            </ul>
          </div>
          <div className="catalogue-header">
            ...
            <form action="" id="form-sorting" className="desktop">
              ...
              <select
                name="sorting"
                id="sort-filter"
                defaultValue="name-ascending"
                onChange={handleItemsSorting}
              >
