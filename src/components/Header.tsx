...
const Header: FC = () => {
  ...
  const handleMenuOpen = ({
    ...
    setMenuOpen(true);
    currentTarget.classList.toggle('visible');
      ...
      <div className="container">
        <nav className="header-nav-bottom">
          ...
          <img
            src={menu}
            alt="Меню"
            className="img-menu visible"
            onClick={handleMenuOpen}
          />
          <img
            src={menuClose}
            alt="Закрыть меню"
            className="img-menu-close"
              ...
              <div className="cart-circle-wrapper">
                ...
                >
                  <circle
                    ...
                    strokeWidth="3"
                  />
                  <text y="19" x="10" fontSize="14" fontWeight="700">
                    {itemsInCart}
                  </text>
                </svg>
              </div>
