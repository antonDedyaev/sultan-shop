            ...
            <div className='container'>
                <div className='footer-content'>
                    <div className='footer-menu menu-1'>
                        <img className='sultan-logo' src={sultanLogoWhite} alt="Белый логотип бренда" />
                        <p>Компания «Султан» — снабжаем
                        ...
                        <div className='email'>
                            ...
                            <img className='email-search-icon' src={arrowRight} alt="Стрелка вправо" />
                        </div>
                    </div>
                    <div className='footer-menu menu-2'>
                        ...
                        <nav className="nav-bottom">
                            <ul className="list-unmarked">
                                <li className="list-item"><a className="link-plain" href="#">О компании</a></li>
                                <li className="list-item"><a className="link-plain" href="#">Доставка и оплата</a></li>
                                <li className="list-item"><a className="link-plain" href="#">Возврат</a></li>
                                <li className="list-item"><a className="link-plain" href="#">Контакты</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div className='footer-menu menu-3'>
                        ...
                        <nav className="nav-bottom">
                            <ul className="list-unmarked">
                                <li className="list-item"><a className="link-plain" href="#">Бытовая химия</a></li>
                                <li className="list-item"><a className="link-plain" href="#">Косметика и гигиена</a></li>
                                <li className="list-item"><a className="link-plain" href="#">Товары для дома</a></li>
                                <li className="list-item"><a className="link-plain" href="#">Товары для детей и мам</a></li>
                                <li className="list-item"><a className="link-plain" href="#">Посуда</a></li>
                            </ul>
                        </nav>
                    </div>
